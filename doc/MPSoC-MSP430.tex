...
\hypersetup{
            pdftitle={Multi-Processor System on Chip with MSP430},
...
\title{Multi-Processor System on Chip with MSP430}
\author{QueenField}
\date{}
...
\subsection{2.1. CORE-MSP430}\label{core-msp430-1}
...
Configuration}\label{basic-system-configuration-1}
...
users)}\label{advanced-system-configuration-for-experienced-users-1}
...
only)}\label{expert-system-configuration-experts-only-1}
...
only)}\label{asic-system-configuration-expertsprofessionals-only-1}
...
edit)}\label{system-constants-do-not-edit-1}
...
\subsection{2.2. PU-MSP430}\label{pu-msp430-1}
...
\subsection{2.4. MPSoC-MSP430}\label{mpsoc-msp430}
